...
| --- | --- |
| `AC-1-1-register-an-account-01` | `TASK-1-1-01`, `TASK-1-1-02`, `TASK-1-1-03` |
| `AC-1-1-register-an-account-02` | `TASK-1-1-01`, `TASK-1-1-02`, `TASK-1-1-03` |
| `AC-1-1-register-an-account-03` | `TASK-1-1-01`, `TASK-1-1-02`, `TASK-1-1-03` |
| `AC-1-1-register-an-account-04` | `TASK-1-1-01`, `TASK-1-1-02`, `TASK-1-1-03` |
| `AC-1-1-register-an-account-05` | `TASK-1-1-01`, `TASK-1-1-02`, `TASK-1-1-03` |

For each AC, `TASK-1-1-03` owns the final cross-layer evidence; `TASK-1-1-01`
and `TASK-1-1-02` supply its approved contract and backend evidence.
...
`E1-COORD-TEST-001` for reusable test tooling. Story acceptance requires task groups
`TASK-1-1-01`–`TASK-1-1-03` and evidence for every canonical AC; local contract variants are rejected.
