...
- [ ] TASK-1-8-02: Deliver immutable Version backend
  ...
  - Verification: 01. Implement Version aggregate and persistence: unit and disposable-PostgreSQL 16 migration/constraint tests. | 02. Implement transactional snapshot application service: unit/PostgreSQL 16 concurrency, rollback and mutation-regression tests. | 03. Expose Version create/detail/list APIs: Laravel feature/contract/PostgreSQL 16 tests. | 04. Verify Version backend contract and immutability: focused PHPUnit suites against disposable PostgreSQL 16.
