...
- [ ] TASK-2-2-02: Deliver revision-safe Job Description management backend
  ...
  - Verification: 01. Implement immutable revision update service: PHPUnit/MySQL no-op, concurrent update, rollback, and source-regression tests. | 02. Implement logical deletion and historical-source resolver: policy/application/MySQL delete race, active-list, and historical report-source tests. | 03. Expose Job Description management APIs: Laravel feature/contract tests with two Users and malformed transport. | 04. Verify revision, deletion, and history backend behavior: approved PHPUnit/MySQL commands and pinned fixture versions.
