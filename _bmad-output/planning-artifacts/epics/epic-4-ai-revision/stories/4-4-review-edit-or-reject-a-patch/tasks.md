...
- [ ] TASK-4-4-02: Deliver Patch review, edit, and rejection backend
  ...
  - Verification: 01. Implement owned Patch read projection and read API: domain/Laravel contract tests with two Users. | 02. Implement bounded Patch edit and revalidation transition: unit/application/PostgreSQL concurrency/rollback tests. | 03. Implement explicit Patch rejection transition: domain/Laravel/PostgreSQL race and rollback tests. | 04. Expose Patch edit and reject APIs: Laravel feature/contract tests with two Users. | 05. Verify Patch decisions, isolation, and state races: approved PHPUnit/PostgreSQL/Vitest/security commands and evidence.
