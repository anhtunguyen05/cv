...
separate lineage identity, immutable predecessor/source, idempotent concurrent/
late/lost outcomes, ownership/non-disclosure, accessible next action, and E2E.
Provider success alone is not Story completion evidence.
