...
- [ ] TASK-4-2-02: Deliver provenance-safe Evidence answer backend
  ...
  - Verification: 01. Implement Evidence Answer persistence and provenance: migration/model/MySQL constraint tests. | 02. Implement answer validation and atomic session transition: domain/application/MySQL concurrency/rollback tests. | 03. Expose Evidence answer/progress APIs: Laravel feature/contract tests with two Users. | 04. Verify Evidence integrity, isolation, and races: approved PHPUnit/MySQL/Vitest/security commands and evidence.
