...
immutable result, applied/provenance atomicity, write-failure rollback,
idempotency/lost response and competing-decision races, accessible recovery, and
E2E. SQLite-only or happy-path unit evidence is insufficient.
